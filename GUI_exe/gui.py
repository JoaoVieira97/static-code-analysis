...
import sys
sys.path.append('./../')
from script1 import printToGUI as print1
from script2 import printToGUI as print2
from script3 import printToGUI as print3
from script4 import printToGUI as print4
